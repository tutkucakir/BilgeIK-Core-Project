...
namespace BilgeIK.WEBUI.Areas.Administrator.Controllers
{
    ...
    public class BaseController : Controller
    {
        ...
        public BaseController(ILogger<DashboardController> logger, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, RoleManager<AppRole> roleManager = null)
        {
            _logger = logger;
