...
namespace BilgeIK.SERVICE.TwoFactorService
{
    public class TwoFactorService
    {
        ...
        public int TimeLeft(HttpContext context)
        {
            ...
            {
                context.Session.SetString("currentTime", DateTime.Now.AddSeconds(_twoFactorOptions.CodeTimeExpire).ToString()); //Startup'daki süre...
            }
        ...
        public string GenerateQrCodeUri(string email, string unformattedKey)
        {
            ...
            return string.Format(format, _urlEncoder.Encode("www.bilgeik.com"), _urlEncoder.Encode(email), unformattedKey);
